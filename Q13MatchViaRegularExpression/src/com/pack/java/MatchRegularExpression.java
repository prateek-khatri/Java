/*1333. Implement regular expression matching with support for '.' and '*'.
...
* same letter occurs 0 or infinity timesin the sequence
...
public static void main(String[] args) {
	...
	System.out.println(sol.isMatch("aaaaddddd", "a*d*"));
